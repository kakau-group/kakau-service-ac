                    ...
                    <div class="col-md-7 col-lg-8">
                      ...
                      <form class="needs-validation" novalidate>
                        <div class="row g-3">
                          ...
                          <a href="index.php" class="btn btn-primary btn-xs">Cuci AC</a>
                          <a href="index.php" class="btn btn-primary btn-xs">Cuci Besar AC Split (Overhaul)</a>
                          <a href="index.php" class="btn btn-primary btn-xs">Perbaikan AC</a>
                          <a href="index.php" class="btn btn-primary btn-xs">Instalasi AC</a>
                          </div>
